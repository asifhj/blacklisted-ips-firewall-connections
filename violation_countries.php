...
<head>
  ...
  <title>Violated countries Barchart.</title>
...
<div class="page-header">
  ...
  <h1> Violated IPS across countries<small></small></h1>
...
<div class="span12">
     <?php
		$row = 1;
		if (($handle = fopen("violated_ips_match_count_by_country.csv", "r")) !== FALSE) 
		{
